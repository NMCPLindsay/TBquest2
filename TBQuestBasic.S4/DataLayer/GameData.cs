    ...
    public static class GameData
    {
        ...
        public static Map GameMapData()
        {
            ...
            (new Location()
            {
                ...
                IsAccessible = true,
                    ...
                    DistanceFromTattooine = 250,
                    DistanceFromHoth = 500,
                GameObjects = new ObservableCollection<GameObjectQuantity>
                    {
                        ...
                        new GameObjectQuantity(GetGameObjectById(3001),1),
                        new GameObjectQuantity(GetGameObjectById(4001),1),
                        new GameObjectQuantity(GetGameObjectById(1002),1)
            ...
            gameMap.Locations.Add
                (new Location()
                {
                    ...
                    DistanceFromTattooine = 0,
                    DistanceFromHoth = 250,
                    GameObjects = new ObservableCollection<GameObjectQuantity>
                    {
                        new GameObjectQuantity(GetGameObjectById(1001),1),
                        new GameObjectQuantity(GetGameObjectById(2001),1),
            ...
            gameMap.CurrentLocation = gameMap.InitialLocation;
            gameMap.StandardGameObjects = StandardGameObjects();
        ...
        public static ObservableCollection<Location> ShipRangeToDistance(Location currentLocation, Ship ship)
        {
            ...
            foreach (Location location in GameMapData().Locations)
            {
                ...
                {
                    if (currentLocation.Name == "Hoth")
                    {
                        if (ship.Range >= location.DistanceFromHoth)
                        {
                    ...
                    else if (currentLocation.Name == "Coruscant")
                    {
                        if (ship.Range >= location.DistanceFromCoruscant)
                        {
                            accessibleLocations.Add(location);
                        }
                        else
                    ...
                    else if (currentLocation.Name == "Tattooine")
                    {
                        if (ship.Range >= location.DistanceFromTattooine)
                        {
                            accessibleLocations.Add(location);
                        }
                        else
        ...
        public static List<GameObjects> StandardGameObjects()
        {
            return new List<GameObjects>()
           {
               ...
               new Ship(4001, "YT7000 Correlian", 250, "A freighter ship known for high speeds", Ship.ShipClasses.Freighter),
